...
export default function HomePage({locale}){
   ...
   return(
    ...
    <section id="/" className="      overflow-auto  flex items-center md:items-stretch lg:items-stretch  flex-col lg:flex-row md:flex-row   
        ...
        <div className="w-11/12  md:w-4/12 lg:w-4/12 xs:w-12/12  text-center rounded flex justify-center   items-center  box_shadow   
                    "style={{ }} >                        
            <Card className='text-center h-full flex items-center justify-center gap-6   flex-wrap  '
                    sx={{ // maxWidth: 345 , 
        ...
        <div className="   w-11/12  md:w-8/12 lg:w-8/12     rounded
               text-2xl    mt-0 flex justify-between flex-col  gap-5        " style={{flex:1,}} >
                ...
                <p    className="m-0 fs-2 ">{t("I'm Aziz Al-Dabry, a front-end developer working to build seamless web experiences using clean code and modern technologies. I also completed a Laravel course, which enabled me to develop integrated back-ends for several projects and connect them to databases.")}</p>                    
